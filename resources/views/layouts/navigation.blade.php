        ...
        <div class="flex justify-between h-16 items-center">
            ...
            <div class="hidden sm:flex sm:items-center">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            class="flex items-center gap-2 px-3 py-2 bg-gray-100 dark:bg-gray-700 rounded-full hover:bg-gray-200 dark:hover:bg-gray-600 transition">
                            <img src="https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->name) }}"
                                class="h-8 w-8 rounded-full" alt="Avatar" />
                            <span
                                class="ms-2 text-sm font-medium text-gray-700 dark:text-gray-200">{{ Auth::user()->name }}</span>
